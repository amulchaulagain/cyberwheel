...
from cyberwheel.utils.multiagent_evaluator import MultiAgentEvaluator
import signal
import sys
...
def evaluate_cyberwheel(args: YAMLConfig, emulate=False):
    ...
    evaluator = MultiAgentEvaluator(args) #EmulatorEvaluator(args) if emulate else Evaluator(args)
